...
def test_user_initialization_and_properties() -> None:
...
def test_user_with_multiple_spaces() -> None:
...
def test_user_with_hyphens_and_underscores() -> None:
...
def test_user_with_very_long_name() -> None:
