...
def test_convert_dict_to_json() -> None:
...
def test_remove_path_from_url() -> None:
...
def test_make_url_without_query_params() -> None:
...
def test_make_url_with_query_params() -> None:
...
def test_compare_two_lists_empty() -> None:
